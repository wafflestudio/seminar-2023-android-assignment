...
class MyMultiAdapter( private val items: List<MyMultiData>, private val goBack: (Int) -> Unit ): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class TypeMainViewHolder(private val binding: TypeMainViewBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(data: MyMultiData.Main, goBack: (Int) -> Unit) {
            ...
            binding.turn.text = turn.toString()
